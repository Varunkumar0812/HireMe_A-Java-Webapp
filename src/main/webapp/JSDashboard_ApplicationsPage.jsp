    ...
    <div class="container">
        ...
        <div class="main-content">
            <div style="width : 89%;">
                ...
                <br>
                <form action="JSApplications_JSJobSearching" method="post">
                	<input type="text" name="emailID" value="<%= emailID %>" style="display : none;"/>
                	<input type="submit" id="search_job_but" value="Search Jobs"/>
                </form>
            </div>
           ...
           <%  		try {
		    			...
		    			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/demoproject", "root", "Tvarun@0812");
		    			Statement stmt = con.createStatement();
		    			ResultSet rs = stmt.executeQuery("SELECT job_id, status FROM Applications WHERE email_id=\"" + emailID + "\"");
