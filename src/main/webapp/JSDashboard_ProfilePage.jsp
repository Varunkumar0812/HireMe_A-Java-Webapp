...
ArrayList<String> skills = new ArrayList<String>();
	...
	try {
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/demoproject", "root", "Tvarun@0812");
		Statement stmt = con.createStatement();
		ResultSet rs = stmt.executeQuery("SELECT skill FROM JS_Skills WHERE email_id=\"" + emailID + "\"");
        ...
        <div class="main-content">
            <div style="width : 89%;">
            	<div style="position: relative; height : 50px;">
                    ...
                    <form action="JSProfile_JSProfileEdit" method="post" style="margin-top : 8px; float : right; height : 50px; width : 15%;">
